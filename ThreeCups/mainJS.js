...
function getItemDataByName(name){
	if (name == "Coffee"){
		...
		return {
			...
			"price": 700
		}; //["Earl Grey", "Green Tea", "Bucks Blend Tea", "Peppermint tea"]
	} else if(name == "Bucks Blend tea - Full fat milk" || name == "Bucks%20Blend%20Tea%20-%20Full%20fat%20milk"){
		return {
			"id": 265,
			"name": "Bucks Blend Tea - Full fat milk",
			"escapedName": "Bucks%20Blend%20Tea%20-%20Full%20fat%20milk",
			"price": 300
		};
	} else if(name == "Bucks Blend tea - Semi-skimmed milk" || name == "Bucks%20Blend%20Tea%20-%20Semi-skimmed%20milk"){
		return {
			"id": 266,
			"name": "Bucks Blend Tea - Semi-skimmed milk",
			"escapedName": "Bucks%20Blend%20Tea%20-%20Semi-skimmed%20milk",
			"price": 300
		};
	} else if(name == "Bucks Blend tea - Skimmed milk" || name == "Bucks%20Blend%20Tea%20-%20Skimmed%20milk"){
		return {
			"id": 267,
			"name": "Bucks Blend Tea - Skimmed milk",
			"escapedName": "Bucks%20Blend%20Tea%20-%20Skimmed%20milk",
			"price": 300
		}; 
	} else if(name == "Bucks Blend tea - No milk" || name == "Bucks%20Blend%20Tea%20-%20Semi-%20No%20milk"){
		return {
			"id": 268,
			"name": "Bucks Blend tea - No milk",
			"escapedName": "Bucks%20Blend%20Tea%20-%20Semi-%20No%20milk",
			"price": 300
		};
	} else if(name == "Bucks Blend tea - Oat milk" || name == "Bucks%20Blend%20Tea%20-%20Oat%20milk"){
		return {
			"id": 270,
			"name": "Bucks Blend tea - Oat milk",
			"escapedName": "Bucks%20Blend%20Tea%20-%20Oat%20milk",
			"price": 300
		};
	}  else if(name == "Green Tea" || name == "Green%20Tea"){
		return {
			"id": 252,
			"name": "Green Tea",
			"escapedName": "Green%20Tea",
			"price": 300
		};
	}  else if(name == "Earl Grey tea - Full fat milk" || name == "Earl%20Grey%20tea%20-%20Full%20fat%20milk" || name == "Earl%20Grey%20tea%20-%20Full%20fat%20milk"){
		return {
			"id": 256,
			"name": "Earl Grey tea - Full fat milk",
			"escapedName": "Earl%20Grey%20tea%20-%20Full%20fat%20milk",
			"price": 300
		};
	}   else if(name == "Earl Grey tea - Skimmed milk" || name == "Earl%20Grey%20tea%20-%20Skimmed%20milk"){
		return {
			"id": 258,
			"name": "Earl Grey tea - Skimmed",
			"escapedName": "Earl%20Grey%20tea%20-%20Skimmed%20milk",
			"price": 300
		};
	}   else if(name == "Earl Grey tea - Semi-skimmed milk" || name == "Earl%20Grey%20tea%20-%20Semi-skimmed%20milk"){
		return {
			"id": 257,
			"name": "Earl Grey tea - Semi-skimmed",
			"escapedName": "Earl%20Grey%20tea%20-%20Semi-skimmed%20milk",
			"price": 300
		};
	}   else if(name == "Earl Grey tea - No milk" || name == "Earl%20Grey%20tea%20-%20No%20milk"){
		return {
			"id": 259,
			"name": "Earl Grey tea - No Milk",
			"escapedName": "Earl%20Grey%20tea%20-%20No%20milk",
			"price": 300
		};
	}   else if(name == "Earl Grey tea - Oat milk" || name == "Earl%20Grey%20tea%20-%20Oat%20milk"){
		return {
			"id": 260,
			"name": "Earl Grey tea - Oat Milk",
...
function addOrderToGrids(orderNum, roundList, orderTotal){
	...
	*/
	...
	let peopleNamesTdEl; //list of peoples names <td> element (table cell for all the names of people listed for the drink)
