...
var teaRounderData = {
	"Categories": {
		"Trade Packs": { 
			...
			"mainSelects": [ 
				["Peppermint tea Trade pack", "Earl Grey Trade Pack"]
			]
		}
	}
...
function getItemDataByName(name){
	...
	if (name == "Peppermint tea Trade pack" || name == "Peppermint%20tea%20Trade%20pack"){
		return {
			"id": 273,
			"name": "Peppermint tea Trade pack",
			"escapedName": "Peppermint%20tea%20Trade%20pack",
			"price": 5000
		};
	} else if (name == "Earl Grey Trade Pack" || name == "Earl%20Grey%20Trade%20Pack"){ 
		return {
			"id": 272,
			"name": "Earl Grey Trade Pack",
